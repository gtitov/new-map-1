const fetchAndFilterCities = async () => {
    ...
    const bigCities = {
        ...allCities,
        features: allCities.features.filter(feature => feature.properties.POP_MAX > 1000000)
    }
    return bigCities
}
...
const deckgl = new deck.DeckGL({
    ...
    layers: [
        ...
        new deck.GeoJsonLayer({
            ...
            pickable: true,
            autoHighlight: true,
            onClick: (info, event) => document.getElementById("name").innerText = `Латинское название города ${info.object.properties.NAME}`
        })
    ]
})